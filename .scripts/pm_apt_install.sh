...
pm_apt_install() {
    ...
    apt-get -y install apt-transport-https curl git grep python3 python3-pip rsync whiptail sqlite3 crudini jq > /dev/null 2>&1 || fatal "Failed to install dependencies from apt."
