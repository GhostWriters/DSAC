...
pm_yum_install() {
    ...
    yum -y install curl git grep newt python36u python36u-pip rsync sed whiptail sqlite3 crudini jq > /dev/null 2>&1 || fatal "Failed to install dependencies from yum."
