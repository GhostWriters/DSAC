...
run_apt() {
    ...
    apt-get -y install apt-transport-https curl git grep python python-pip rsync sed whiptail sqlite3 > /dev/null 2>&1 || fatal "Failed to install dependencies from apt."
